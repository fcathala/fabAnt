:Main
  ...
  Echo.
  Echo ----------------------------------------------------------
  Echo  fabAnt - (3) Download components from manifest
  Echo ----------------------------------------------------------
  Echo.
  ...
  Call ant retrieveCode -buildfile "lib\fabAnt.xml" -propertyfile "lib\org.down.properties" -l "metadata\temp\log.txt"
